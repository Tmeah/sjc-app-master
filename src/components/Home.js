        ...
        <Row className="d-flex align-center ">
          ...
          >
            <h1 className="landing-header">
              Transform Your Grades with <span class="educam">EduCam.</span>
              <br />
              <div class="text-with-svg-underline">
                A<span class="superscript">☆</span> Standard
                <svg
            ...
            <p className="landing-text my-3">
              At EduCam, we don't just promise excellence — we guarantee it. Our
              unique tutoring approach, rooted in the prestigious Cambridge
              tradition, offers a personalized pathway to not just meet, but
              exceed your academic goals. With EduCam, you're not just another
              student; you're a future success story.
            </p>
